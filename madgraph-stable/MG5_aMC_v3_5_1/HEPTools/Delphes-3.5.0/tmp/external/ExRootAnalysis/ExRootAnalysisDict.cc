...
namespace ROOT {
   ...
   int RecordReadRules_ExRootAnalysisDict() {
      return 0;
   }
   static int _R__UNIQUE_DICT_(ReadRules_ExRootAnalysisDict) = RecordReadRules_ExRootAnalysisDict();R__UseDummy(_R__UNIQUE_DICT_(ReadRules_ExRootAnalysisDict));
} // namespace ROOT
namespace {
...
"external",
"/usr/include/root",
"/vols/cms/us322/nsbi_for_dihiggs/madgraph-stable/MG5_aMC_v3_5_1/HEPTools/Delphes-3.5.0/",
nullptr
    };
