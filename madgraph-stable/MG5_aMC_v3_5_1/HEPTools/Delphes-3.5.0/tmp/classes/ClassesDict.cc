...
namespace ROOT {
   ...
   int RecordReadRules_ClassesDict() {
      return 0;
   }
   static int _R__UNIQUE_DICT_(ReadRules_ClassesDict) = RecordReadRules_ClassesDict();R__UseDummy(_R__UNIQUE_DICT_(ReadRules_ClassesDict));
} // namespace ROOT
namespace {
