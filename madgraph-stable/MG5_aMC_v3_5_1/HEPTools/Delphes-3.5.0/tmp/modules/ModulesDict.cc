...
namespace ROOT {
   ...
   int RecordReadRules_ModulesDict() {
      return 0;
   }
   static int _R__UNIQUE_DICT_(ReadRules_ModulesDict) = RecordReadRules_ModulesDict();R__UseDummy(_R__UNIQUE_DICT_(ReadRules_ModulesDict));
} // namespace ROOT
namespace {
