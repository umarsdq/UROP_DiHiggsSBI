...
namespace ROOT {
   ...
   int RecordReadRules_FastJetDict() {
      return 0;
   }
   static int _R__UNIQUE_DICT_(ReadRules_FastJetDict) = RecordReadRules_FastJetDict();R__UseDummy(_R__UNIQUE_DICT_(ReadRules_FastJetDict));
} // namespace ROOT
namespace {
