...
C     
      SUBROUTINE MP_VVS12L2P0_1(P2, S3, COUP, M1, W1, P1, COEFF)
      IMPLICIT NONE
      COMPLEX*32 CI
      ...
      COEFF(1,0,1)= COUP*S3(5)*(+CI*(P2(0)*P1(0))-CI*(TMP2))
      COEFF(2,0,1)= COUP*CI * P2(1)*S3(5)*P1(0)
      COEFF(3,0,1)= COUP*CI * P2(2)*S3(5)*P1(0)
      COEFF(4,0,1)= COUP*CI * P2(3)*S3(5)*P1(0)
      COEFF(1,1,1)= 0Q0
      ...
      COEFF(2,2,1)= COUP*CI * S3(5)*P1(0)
      COEFF(3,2,1)= 0Q0
      COEFF(4,2,1)= 0Q0
      COEFF(1,3,1)= COUP*S3(5)*(+CI*(P2(2)+P1(2)))
      COEFF(2,3,1)= 0Q0
      COEFF(3,3,1)= COUP*CI * S3(5)*P1(0)
      COEFF(4,3,1)= 0Q0
      COEFF(1,4,1)= COUP*S3(5)*(+CI*(P2(3)+P1(3)))
      COEFF(2,4,1)= 0Q0
      COEFF(3,4,1)= 0Q0
      COEFF(4,4,1)= COUP*CI * S3(5)*P1(0)
      COEFF(1,5,1)= 0Q0
      COEFF(2,5,1)= 0Q0
      COEFF(3,5,1)= 0Q0
      COEFF(4,5,1)= 0Q0
      ...
      COEFF(3,14,1)= 0Q0
      COEFF(4,14,1)= 0Q0
      COEFF(1,0,2)= COUP*-CI * P2(0)*S3(5)*P1(1)
      COEFF(2,0,2)= COUP*-S3(5)*(+CI*(P2(1)*P1(1)+TMP2))
      COEFF(3,0,2)= COUP*-CI * P2(2)*S3(5)*P1(1)
      COEFF(4,0,2)= COUP*-CI * P2(3)*S3(5)*P1(1)
      COEFF(1,1,2)= COUP*-CI * S3(5)*P1(1)
      ...
      COEFF(3,3,2)= COUP*-CI * S3(5)*P1(1)
      COEFF(4,3,2)= 0Q0
      COEFF(1,4,2)= 0Q0
      COEFF(2,4,2)= COUP*S3(5)*(+CI*(P2(3)+P1(3)))
      COEFF(3,4,2)= 0Q0
      COEFF(4,4,2)= COUP*-CI * S3(5)*P1(1)
      COEFF(1,5,2)= 0Q0
      ...
      COEFF(3,14,2)= 0Q0
      COEFF(4,14,2)= 0Q0
      COEFF(1,0,3)= COUP*-CI * P2(0)*S3(5)*P1(2)
      COEFF(2,0,3)= COUP*-CI * P2(1)*S3(5)*P1(2)
      COEFF(3,0,3)= COUP*-S3(5)*(+CI*(P2(2)*P1(2)+TMP2))
      COEFF(4,0,3)= COUP*-CI * P2(3)*S3(5)*P1(2)
      COEFF(1,1,3)= COUP*-CI * S3(5)*P1(2)
      COEFF(2,1,3)= 0Q0
      COEFF(3,1,3)= COUP*-S3(5)*(+CI*(P2(0)+P1(0)))
      COEFF(4,1,3)= 0Q0
      COEFF(1,2,3)= 0Q0
      COEFF(2,2,3)= COUP*-CI * S3(5)*P1(2)
      ...
      COEFF(4,14,3)= 0Q0
      COEFF(1,0,4)= COUP*-CI * P2(0)*S3(5)*P1(3)
      COEFF(2,0,4)= COUP*-CI * P2(1)*S3(5)*P1(3)
      COEFF(3,0,4)= COUP*-CI * P2(2)*S3(5)*P1(3)
      COEFF(4,0,4)= COUP*-S3(5)*(+CI*(P2(3)*P1(3)+TMP2))
      COEFF(1,1,4)= COUP*-CI * S3(5)*P1(3)
      COEFF(2,1,4)= 0Q0
      COEFF(3,1,4)= 0Q0
      COEFF(4,1,4)= COUP*-S3(5)*(+CI*(P2(0)+P1(0)))
      COEFF(1,2,4)= 0Q0
      COEFF(2,2,4)= COUP*-CI * S3(5)*P1(3)
      COEFF(3,2,4)= 0Q0
      COEFF(4,2,4)= COUP*S3(5)*(+CI*(P2(1)+P1(1)))
      COEFF(1,3,4)= 0Q0
      COEFF(2,3,4)= 0Q0
      COEFF(3,3,4)= COUP*-CI * S3(5)*P1(3)
