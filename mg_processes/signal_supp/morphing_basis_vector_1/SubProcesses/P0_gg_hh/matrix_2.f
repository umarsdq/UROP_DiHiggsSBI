...
C     
C     
C     Process: u~ g > h h u~ NP<=2 QCD<=100 QED<=99 [ all = QCD ]
C      NP^2=4 QCD^2<=6 QED^2<=4
C     Process: c~ g > h h c~ NP<=2 QCD<=100 QED<=99 [ all = QCD ]
C      NP^2=4 QCD^2<=6 QED^2<=4
C     Process: d~ g > h h d~ NP<=2 QCD<=100 QED<=99 [ all = QCD ]
C      NP^2=4 QCD^2<=6 QED^2<=4
C     Process: s~ g > h h s~ NP<=2 QCD<=100 QED<=99 [ all = QCD ]
C      NP^2=4 QCD^2<=6 QED^2<=4
C     Process: b~ g > h h b~ NP<=2 QCD<=100 QED<=99 [ all = QCD ]
C      NP^2=4 QCD^2<=6 QED^2<=4
C     
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV57P0_3(W(1,5),W(1,1),GC_11,ZERO,ZERO,W(1,6))
