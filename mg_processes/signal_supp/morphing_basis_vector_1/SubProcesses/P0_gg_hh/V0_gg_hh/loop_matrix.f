...
C     
C     Process: g g > h h NP<=2 QCD<=100 QED<=99 [ all = QCD ] NP^2=4
C      QCD^2<=6 QED^2<=4
C     
C     Modules
C     
...
C      precision or when TIR_CACHE_SIZE<2.
     ...
     $ .NE.5).AND.(TIRCACHE_INDEX(CTMODE).EQ.(TIR_CACHE_SIZE+1))) THEN
...
C     
      ...
      DATA (SQPLITORDERS(  1,I),I=  1,  3) /    4,    2,    3/
      DATA (SQPLITORDERS(  2,I),I=  1,  3) /    2,    2,    4/
      DATA (SQPLITORDERS(  3,I),I=  1,  3) /    4,    2,    4/
...
C     
      ...
      DATA (LOOPAMPORDERS(I),I=  1,  5) /    2,    3,    3,    4,    4/
      DATA (LOOPAMPORDERS(I),I=  6, 10) /    4,    4,    4,    4,    4/
      DATA (LOOPAMPORDERS(I),I= 11, 15) /    4,    4,    4,    4,    4/
      ...
      DATA (LOOPAMPORDERS(I),I= 41, 45) /    4,    2,    2,    3,    3/
      ...
      DATA (LOOPAMPORDERS(I),I=121,123) /    4,    4,    4/
C     -----------
C     BEGIN CODE
C     -----------
...
C     
      ...
      DATA (AMPSPLITORDERS(  1,I),I=  1,  3) /    2,    0,    2/
      DATA (AMPSPLITORDERS(  2,I),I=  1,  3) /    2,    2,    1/
      DATA (AMPSPLITORDERS(  3,I),I=  1,  3) /    0,    2,    2/
      DATA (AMPSPLITORDERS(  4,I),I=  1,  3) /    2,    2,    2/
