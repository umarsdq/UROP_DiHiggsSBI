...
C     
C     
C     Process: u g > h h u NP<=2 QCD<=100 QED<=99 [ all = QCD ] NP^2=4
C      QCD^2<=6 QED^2<=4
C     Process: c g > h h c NP<=2 QCD<=100 QED<=99 [ all = QCD ] NP^2=4
C      QCD^2<=6 QED^2<=4
C     Process: d g > h h d NP<=2 QCD<=100 QED<=99 [ all = QCD ] NP^2=4
C      QCD^2<=6 QED^2<=4
C     Process: s g > h h s NP<=2 QCD<=100 QED<=99 [ all = QCD ] NP^2=4
C      QCD^2<=6 QED^2<=4
C     Process: b g > h h b NP<=2 QCD<=100 QED<=99 [ all = QCD ] NP^2=4
C      QCD^2<=6 QED^2<=4
C     
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV57P0_3(W(1,1),W(1,5),GC_11,ZERO,ZERO,W(1,6))
      CALL SSS6_1(W(1,3),W(1,4),GC_322,MDL_MH,MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS12_0(W(1,6),W(1,2),W(1,5),GC_336,AMP(1))
C     Amplitude(s) for diagram number 2
      CALL VVSS15_0(W(1,2),W(1,6),W(1,3),W(1,4),GC_65,AMP(2))
