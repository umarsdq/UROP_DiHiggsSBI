...
C     
C     
C     Process: g u~ > h h u~ NP<=2 QCD<=100 QED<=99 [ all = QCD ]
C      NP^2=4 QCD^2<=6 QED^2<=4
C     Process: g c~ > h h c~ NP<=2 QCD<=100 QED<=99 [ all = QCD ]
C      NP^2=4 QCD^2<=6 QED^2<=4
C     Process: g d~ > h h d~ NP<=2 QCD<=100 QED<=99 [ all = QCD ]
C      NP^2=4 QCD^2<=6 QED^2<=4
C     Process: g s~ > h h s~ NP<=2 QCD<=100 QED<=99 [ all = QCD ]
C      NP^2=4 QCD^2<=6 QED^2<=4
C     Process: g b~ > h h b~ NP<=2 QCD<=100 QED<=99 [ all = QCD ]
C      NP^2=4 QCD^2<=6 QED^2<=4
C     
C     
C     CONSTANTS
...
C     ----------
      ...
      CALL FFV57P0_3(W(1,5),W(1,2),GC_11,ZERO,ZERO,W(1,6))
...
C     Amplitude(s) for diagram number 2
      CALL FFV57_0(W(1,5),W(1,2),W(1,7),GC_11,AMP(2))
