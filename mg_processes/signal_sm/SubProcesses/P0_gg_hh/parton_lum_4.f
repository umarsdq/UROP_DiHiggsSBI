...
C     
      ...
      DOUBLE PRECISION BX2_COMPONENTS(N_EE),CX2_COMPONENTS(N_EE)
     $ ,SX2_COMPONENTS(N_EE),UX2_COMPONENTS(N_EE),DX2_COMPONENTS(N_EE)
...
C         
     ...
     $ =EE_COMP_PROD(G1_COMPONENTS,SX2_COMPONENTS)
      ...
      IF (ABS(LPP(1)).EQ.ABS(LPP(2)).AND. (ABS(LPP(1))
     $ .EQ.3.OR.ABS(LPP(1)).EQ.4).AND.PDLABEL.NE.'none')PD(IPROC)
     $ =EE_COMP_PROD(G1_COMPONENTS,BX2_COMPONENTS)
      DO I=1,IPROC
