...
C     Here we leave the default target squared split order to -1,
C      meaning that we aim at computing all individual contributions.
C      You can choose otherwise.
...
C       
     ...
     $     //' combination.'
          WRITE(*,*) 'All Born contributions are of split orders (NP=4'
     $     //' QCD=0 QED=4)'
          WRITE (*,*) '---------------------------------'
          WRITE(*,*) '1L) Loop ME for orders (NP=4 QCD=2 QED=3) :'
          IF (PREC_FOUND(1).NE.-1.0D0) THEN
            WRITE(*,*) ' > accuracy = ',PREC_FOUND(1)
          ELSE
            WRITE(*,*) ' > accuracy =   NA'
          ENDIF
          WRITE(*,*) ' > finite   = ',MATELEM(1,1)
          WRITE(*,*) ' > 1eps     = ',MATELEM(2,1)
          WRITE(*,*) ' > 2eps     = ',MATELEM(3,1)
          WRITE(*,*) '2L) Loop ME for orders (NP=2 QCD=2 QED=4) :'
          IF (PREC_FOUND(2).NE.-1.0D0) THEN
            WRITE(*,*) ' > accuracy = ',PREC_FOUND(2)
          ELSE
            WRITE(*,*) ' > accuracy =   NA'
          ENDIF
          WRITE(*,*) ' > finite   = ',MATELEM(1,2)
          WRITE(*,*) ' > 1eps     = ',MATELEM(2,2)
          WRITE(*,*) ' > 2eps     = ',MATELEM(3,2)
          WRITE(*,*) '3L) Loop ME for orders (NP=4 QCD=2 QED=4) :'
          IF (PREC_FOUND(3).NE.-1.0D0) THEN
            WRITE(*,*) ' > accuracy = ',PREC_FOUND(3)
          ELSE
            WRITE(*,*) ' > accuracy =   NA'
          ENDIF
          WRITE(*,*) ' > finite   = ',MATELEM(1,3)
          WRITE(*,*) ' > 1eps     = ',MATELEM(2,3)
          WRITE(*,*) ' > 2eps     = ',MATELEM(3,3)
          WRITE (*,*) '---------------------------------'
     ...
     $     ,NSQUAREDSO)
          WRITE (69,*) 'Born_SO_Results 4 0 4'
          WRITE (69,*) 'SO_Born BORN ',MATELEM(0,1)
          WRITE (69,*) 'Split_Orders_Names NP QCD QED'
          WRITE (69,*) 'Loop_SO_Results 4 2 3'
          ...
          WRITE (69,*) 'Loop_SO_Results 2 2 4'
          WRITE (69,*) 'SO_Loop ACC  ',PREC_FOUND(2)
          WRITE (69,*) 'SO_Loop FIN  ',MATELEM(1,2)
          WRITE (69,*) 'SO_Loop 1EPS ',MATELEM(2,2)
          WRITE (69,*) 'SO_Loop 2EPS ',MATELEM(3,2)
          WRITE (69,*) 'Loop_SO_Results 4 2 4'
          WRITE (69,*) 'SO_Loop ACC  ',PREC_FOUND(3)
          WRITE (69,*) 'SO_Loop FIN  ',MATELEM(1,3)
          WRITE (69,*) 'SO_Loop 1EPS ',MATELEM(2,3)
          WRITE (69,*) 'SO_Loop 2EPS ',MATELEM(3,3)
          CLOSE(69)
        ELSE
