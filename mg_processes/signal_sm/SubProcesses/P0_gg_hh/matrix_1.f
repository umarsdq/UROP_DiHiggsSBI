...
C     
C     
C     Process: g g > h h g NP<=2 QCD<=100 QED<=99 [ all = QCD ] NP^2=4
C      QCD^2<=6 QED^2<=4
C     
C     
C     CONSTANTS
...
C     COLOR DATA
C     
      DATA (CF(I,  1),I=  1,  2) /2.333333333333333D+00,
     $ -6.666666666666666D-01/
C     1 Tr(1,2,5)
      DATA (CF(I,  2),I=  1,  2) /-6.666666666666666D-01
     $ ,2.333333333333333D+00/
C     1 Tr(1,5,2)
C     ----------
C     BEGIN CODE
C     ----------
...
C     Amplitude(s) for diagram number 1
      CALL VVVSS25_0(W(1,1),W(1,2),W(1,5),W(1,3),W(1,4),GC_153,AMP(1))
      CALL VVV8P0_1(W(1,1),W(1,2),GC_10,ZERO,ZERO,W(1,6))
      CALL SSS6_1(W(1,3),W(1,4),GC_322,MDL_MH,MDL_WH,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL VVS12_0(W(1,6),W(1,5),W(1,7),GC_336,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL VVSS15_0(W(1,5),W(1,6),W(1,3),W(1,4),GC_65,AMP(3))
      CALL VVV8P0_1(W(1,1),W(1,5),GC_10,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL VVS12_0(W(1,6),W(1,2),W(1,7),GC_336,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVSS15_0(W(1,2),W(1,6),W(1,3),W(1,4),GC_65,AMP(5))
      CALL VVV8P0_1(W(1,2),W(1,5),GC_10,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 6
      CALL VVS12_0(W(1,1),W(1,6),W(1,7),GC_336,AMP(6))
      CALL VVVS17_4(W(1,1),W(1,2),W(1,5),GC_357,MDL_MH,MDL_WH,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL SSS6_0(W(1,3),W(1,4),W(1,6),GC_322,AMP(7))
      CALL VVSS15P0_1(W(1,1),W(1,3),W(1,4),GC_65,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 8
      CALL VVV8_0(W(1,2),W(1,5),W(1,6),GC_10,AMP(8))
C     JAMPs contributing to orders NP=2 QCD=1 QED=2
...
C     
      ...
      DATA (AMPSPLITORDERS(  1,I),I=  1,  3) /    2,    1,    2/
C     
C     FUNCTION
C     
...
C     the values listed below are for NP, QCD, QED
      DATA (SQSPLITORDERS(  1,I),I=  1,  3) /    4,    2,    4/
C     
C     BEGIN CODE
C     
      DO I=1,NSQAMPSO
