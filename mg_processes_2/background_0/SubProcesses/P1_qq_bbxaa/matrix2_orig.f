...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_2(W(1,1),W(1,5),GC_1,ZERO, FK_ZERO,W(1,12))
      CALL FFV1_1(W(1,2),W(1,6),GC_1,ZERO, FK_ZERO,W(1,7))
      CALL FFV1P0_3(W(1,4),W(1,3),GC_11,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,12),W(1,7),W(1,13),GC_11,AMP(7))
      CALL FFV1_2(W(1,12),W(1,6),GC_1,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 8
      CALL FFV1_0(W(1,14),W(1,2),W(1,13),GC_11,AMP(8))
      CALL FFV1P0_3(W(1,12),W(1,2),GC_11,ZERO, FK_ZERO,W(1,14))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,4),W(1,11),W(1,14),GC_11,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,10),W(1,3),W(1,14),GC_11,AMP(10))
      CALL FFV1_2(W(1,1),W(1,6),GC_1,ZERO, FK_ZERO,W(1,14))
      CALL FFV1_1(W(1,2),W(1,5),GC_1,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,14),W(1,12),W(1,13),GC_11,AMP(11))
      CALL FFV1_2(W(1,14),W(1,5),GC_1,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,15),W(1,2),W(1,13),GC_11,AMP(12))
      CALL FFV1P0_3(W(1,14),W(1,2),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,4),W(1,8),W(1,15),GC_11,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,9),W(1,3),W(1,15),GC_11,AMP(14))
      CALL FFV1_2(W(1,1),W(1,13),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,15),W(1,12),W(1,6),GC_1,AMP(15))
      CALL FFV1P0_3(W(1,1),W(1,12),GC_11,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,4),W(1,11),W(1,6),GC_11,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,10),W(1,3),W(1,6),GC_11,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,15),W(1,7),W(1,5),GC_1,AMP(18))
      CALL FFV1P0_3(W(1,1),W(1,7),GC_11,ZERO, FK_ZERO,W(1,15))
C     Amplitude(s) for diagram number 19
      CALL FFV1_0(W(1,4),W(1,8),W(1,15),GC_11,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,9),W(1,3),W(1,15),GC_11,AMP(20))
